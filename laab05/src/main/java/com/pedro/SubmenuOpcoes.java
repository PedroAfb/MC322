...
public enum SubmenuOpcoes {
	...
	LISTAR_SINISTRO_SEGURO_PF("Listar os sinistros de um seguro PF"),
	LISTAR_SINISTRO_SEGURO_PJ("Listar os sinistros de um seguro PJ"),
	LISTAR_FROTA("Listar as frotas de um cliente"),
	LISTAR_VEICULO_CLIENTE("Listar os veículos de um cliente PF"),
	LISTAR_VEICULO_FROTA("Listar os veículos de uma frota"),
	LISTAR_CONDUTORES_PF("Listar os condutores de um seguro PF"),
	LISTAR_CONDUTORES_PJ("Listar os condutores de um seguro PJ"),
